                        ...
                        <div className="space-y-3">
                         ...
                         bg-clip-text text-transparent text-4xl leading-tight"
                            ...
                            <p data-stagger className="text-sm leading-snug text-gray-300">
                                ...
                                <span className="text-teal-300">Spring Boot</span>. My primary focus is building secure,
                                scalable{" "}
                            ...
                            <p data-stagger className="text-sm leading-snug text-gray-300">
                                ...
                                <span className="text-blue-300">TailwindCSS</span> to create responsive and modern UIs.
                                I enjoy
                                integrating the backend with efficient frontend architectures, ensuring smooth data flow
                                through state
                            ...
                            <p data-stagger className="text-sm leading-snug text-gray-300">
                                ...
                                <span className="text-cyan-300">shader programming</span> as creative experiments. This
                                helps me blend
                                logic and visuals when needed.
                            </p>

                            <p data-stagger className="text-sm leading-snug text-gray-300">
                                🚀 My approach: write clean, maintainable, and secure code; optimize performance; and
                                continuously learn
