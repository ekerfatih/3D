                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <section data-stagger className="space-y-3">
                            ...
                            <p className="text-sm md:text-[15px] leading-relaxed text-gray-200/90">
                                Backend-oriented Full Stack Developer with a mechanical engineering background. Strong
                                in{" "}
                                ...
                                (<span className="text-sky-300">PostgreSQL</span>, <span
                                className="text-sky-300">MSSQL</span>).
                        ...
                        <div className="space-y-8">
                            ...
                            <section data-stagger>
                              ...
                              bg-white/5 border border-white/10 rounded-full px-3 py-1 mb-3">
                                ...
                                <div className="space-y-4 text-sm md:text-[15px]">
                                    <div>
                                        <div className="font-medium text-gray-100">Workintech — Full Stack Development
                                            Program
                                        </div>
                                    ...
                                    <div>
                                        <div className="font-medium text-gray-100">Sakarya University — Mechanical
                                            Engineering
                                        </div>
                            ...
                            <section data-stagger>
                              ...
                              bg-white/5 border border-white/10 rounded-full px-3 py-1 mb-3">
                                ...
                                <ul className="text-sm md:text-[15px] space-y-2">
                                    <li><span className="text-teal-300">Back End Development</span> — Workintech —
                                        10.2025
                                    </li>
                                    <li><span className="text-blue-300">Front End Development</span> — Workintech —
                                        06.2025
                                    </li>
                                    <li><span className="text-sky-300">Game Development</span> — Uskudar University —
                                        06.2022
                                    </li>
                                </ul>
                            </section>
